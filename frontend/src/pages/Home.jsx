...
const Home = () => {
    ...
    return (
        <main className="flex flex-col mb-10">
            <div className="text-center bg-[url(http://127.0.0.1:8000/storage/banner.png)] bg-no-repeat bg-cover bg-center">
                <div className="flex flex-col items-center justify-center max-md:h-[60vh] md:h-[80vh] bg-[#00000066] text-white space-y-12">
                    <p className="bg-[#FDD6D6] text-[#F54748] flex py-3 px-5 rounded-full text-base font-semibold">Beyond Speedy <img src="http://127.0.0.1:8000/storage/icone/pizza.png" alt="icone pizza"/></p>
